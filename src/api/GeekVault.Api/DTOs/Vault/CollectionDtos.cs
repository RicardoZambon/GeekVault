...
public record CollectionResponse(int Id, string Name, string? Description, string? CoverImage, string Visibility, int CollectionTypeId, string CollectionTypeName, int ItemCount, DateTime CreatedAt, DateTime? UpdatedAt);
